    ...
    callback: (message, args) => {
        ...
        if(message.member.hasPermission('BAN_MEMBERS')){
            ...
            if(!user){
                ...
                .setDescription(`<:emojino:779190801598775317> Please mention a member to soft-ban!`)
                .setColor('RED')
                .setFooter('GEconomee')
                .setTimestamp()
            ...
            if(user.hasPermission('MANAGE_GUILD')){
                const embed = new MessageEmbed()
                .setDescription(`<:emojino:779190801598775317> That user is a mod/admin! I can't soft-ban them!`)
                .setColor('RED')
                .setFooter('GEconomee')
                .setTimestamp()
                message.channel.send(embed)
                ...
                message.guild.members.unban(user.id, 'Soft-Ban')
                const embed = new MessageEmbed()
                .setDescription(`<:emojiyes:779190801392861224> Successfully soft-banned <@${user.id}>!`)
                .setColor('GREEN')
                .setFooter('GEconomee')
                .setTimestamp()
                message.channel.send(embed)
